 ...
 */
@Entity
@Table(name = "order_detail", catalog = "bookstore_db")
public class OrderDetail implements java.io.Serializable {
	...
	@AttributeOverrides({ @AttributeOverride(name = "orderFk", column = @Column(name = "order_fk")),
			@AttributeOverride(name = "bookFk", column = @Column(name = "book_fk")),
